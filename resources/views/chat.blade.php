            ...
            <div class="">
                <div class="form p-2 py-4 shadow-lg px-0 mastercard ">
                    ...
                    <ul class="list-group">
                             ...
                             <li class="list-group-item w-100"><a href="/dashboard/{{$friends->id}}"><img src="/uploads/avatars/{{$friends->avatar}}"  class="rounded-circle" style="width:40px;height:38px"></a> <a class="text" href="/chat/{{$friends->username}}">{{$friends->username}}</a> <span style="width:10px;height:10px" class="rounded-circle float-right bg-success"></span></li>
